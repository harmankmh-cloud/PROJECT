    ...
    <div className="mesh-bg flex min-h-screen flex-col">
      ...
      <main id="main-content" className="mx-auto max-w-3xl flex-1 px-6 py-16">
        ...
        <div className="prose prose-slate mt-8 max-w-none space-y-6 text-sm leading-relaxed text-slate-600">
          <section>
            <h2 className="text-lg font-semibold text-brand-900">Who we are</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-brand-900">Information we collect</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-brand-900">How we use data</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-brand-900">Third-party processors</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-brand-900">HIPAA & compliance</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-brand-900">Your rights</h2>
            <p>
