...
export function BrandLogo({
  ...
  return (
    <Link href={href} className="group inline-flex items-center gap-3">
      <div
        className={`${s.box} flex items-center justify-center rounded-2xl bg-gradient-to-br from-teal-400 via-violet-500 to-teal-300 font-bold text-white ring-2 ring-white/20 shadow-[0_8px_28px_rgba(20,184,166,0.45)] transition duration-300 group-hover:scale-105`}
      >
        ☎
      </div>
