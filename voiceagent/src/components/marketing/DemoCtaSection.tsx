      ...
      <div className="marketing-container">
        <FadeInSection>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="glass-card mx-auto mt-10 max-w-lg p-6 text-left">
              {videoUrl && playing ? (
                <div className="aspect-video overflow-hidden rounded-lg">
                  <iframe
                    src={videoUrl.includes("youtube") ? videoUrl.replace("watch?v=", "embed/") : videoUrl}
                    title="GreetQ demo video"
                ...
                <>
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <p className="text-sm text-muted">Interactive transcript demo</p>
                  </div>
                  <div className="mt-4 min-h-[140px] rounded-lg bg-bg/50">
                    <TranscriptPreview />
                  </div>
                </>
              )}
