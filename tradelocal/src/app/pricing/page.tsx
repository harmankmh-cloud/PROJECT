  ...
  return (
    <main className="mesh-bg min-h-screen">
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-8">
        <p className="section-eyebrow">{TRADE_LOCAL.name} for pros</p>
        <h1 className="font-display mt-2 text-4xl text-brand-950">Plans that pay for themselves</h1>
        <p className="mt-3 max-w-2xl text-lg text-slate-600">
          Angi and Thumbtack charge $30–100+ per lead. TradeLocal lets customers call you direct — upgrade for visibility, verified badges, and premium placement.
        </p>
        <div className="mt-12">
          <PricingCards />
        </div>
