...
insert into service_providers (
  ...
  -- Richmond (placeholder — pending real pro activation)
  ('richmond-coming-soon-plumber', 'Richmond Plumbing — Coming Soon', 'plumber', 'richmond', '604-555-0901', null, null, 'Profile pending activation — post a job to get matched manually with a vetted Richmond plumber.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('richmond-coming-soon-electrician', 'Richmond Electric — Coming Soon', 'electrician', 'richmond', '604-555-0902', null, null, 'Profile pending activation — post a job to get matched manually with a vetted Richmond electrician.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('richmond-coming-soon-handyman', 'Richmond Handyman — Coming Soon', 'handyman', 'richmond', '604-555-0903', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  -- Coquitlam
  ('coquitlam-coming-soon-plumber', 'Coquitlam Plumbing — Coming Soon', 'plumber', 'coquitlam', '604-555-1001', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('coquitlam-coming-soon-hvac', 'Coquitlam HVAC — Coming Soon', 'hvac', 'coquitlam', '604-555-1002', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('coquitlam-coming-soon-cleaner', 'Coquitlam Cleaning — Coming Soon', 'cleaner', 'coquitlam', '604-555-1003', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  -- Maple Ridge
  ('maple-ridge-coming-soon-landscaper', 'Maple Ridge Landscaping — Coming Soon', 'landscaper', 'maple-ridge', '604-555-1101', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('maple-ridge-coming-soon-roofer', 'Maple Ridge Roofing — Coming Soon', 'roofer', 'maple-ridge', '604-555-1102', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('maple-ridge-coming-soon-handyman', 'Maple Ridge Handyman — Coming Soon', 'handyman', 'maple-ridge', '604-555-1103', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  -- Kelowna
  ('kelowna-coming-soon-plumber', 'Kelowna Plumbing — Coming Soon', 'plumber', 'kelowna', '250-555-1201', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('kelowna-coming-soon-hvac', 'Kelowna HVAC — Coming Soon', 'hvac', 'kelowna', '250-555-1202', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0),
  ('kelowna-coming-soon-landscaper', 'Kelowna Landscaping — Coming Soon', 'landscaper', 'kelowna', '250-555-1203', null, null, 'Profile pending activation — post a job to get matched manually.', 0, false, 'approved', false, 'free', false, false, false, null, null, 0)
