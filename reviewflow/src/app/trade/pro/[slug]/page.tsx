...
import { ProviderContactButtons } from "@/components/tradelocal/ProviderContactButtons";
import { TRADE_LOCAL, cityName } from "@/lib/tradelocal/constants";
import { getCategoryBySlug, getProviderBySlug } from "@/lib/tradelocal/data";

export default async function TradeProviderPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="mesh-bg min-h-screen">
      <header className="site-header px-4 py-4 sm:px-8">
        <Link
          href={`/trade/${provider.city_slug}/${provider.category_slug}`}
