  ...
  return (
    <main className="flex-1 px-4 py-8 sm:px-8">
      <div className="mx-auto max-w-4xl space-y-6">
        <header>
          <p className="text-xs font-semibold uppercase tracking-widest text-gold-600">Control center</p>
          <h1 className="font-display mt-1 text-3xl text-brand-950">Customer reviews</h1>
